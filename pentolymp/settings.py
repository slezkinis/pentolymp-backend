...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=env.int("ACCESS_TOKEN_LIFETIME_MINUTE", 60)),
    'REFRESH_TOKEN_LIFETIME': timedelta(minutes=env.int('REFRESH_TOKEN_LIFETIME_DAYS', 7)),
...
'default': {
        ...
        'PASSWORD': env.str("DATABASE_PASSWORD", 'userpass'),
